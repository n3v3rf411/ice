...
public class Region extends Tag {
    ...
    public static final Region EU_WEST_2 = new Region("eu-west-2", "EUW2"); // Need to verify proper code
    public static final Region EU_CENTRAL_1 = new Region("eu-central-1", "EUC1");
    public static final Region AP_SOUTH_1 = new Region("ap-south-1", "AP1"); // Need to verify proper code
